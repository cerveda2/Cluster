...
import cz.vse.dp.dc.logic.ClusterConfig;
import cz.vse.dp.dc.logic.DistributionType;
import cz.vse.dp.dc.logic.PointEx;
import cz.vse.dp.dc.logic.Tools;
...
public class MainWindow {
    ...
    private static void setInnerGrid (GridPane grid) {
        ...
        countArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
            validate(countArea, newValue);
        });
        perimeterArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
            validate(perimeterArea, newValue);
        });
        distanceArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
            validate(distanceArea, newValue);
        });
        scaleArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
            validate(scaleArea, newValue);
        });
        dimensionsArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
            validate(dimensionsArea, newValue);
        });
        iterationsArea.textProperty().addListener((ObservableValue<? extends String> observable, String oldValue, String newValue) -> {
